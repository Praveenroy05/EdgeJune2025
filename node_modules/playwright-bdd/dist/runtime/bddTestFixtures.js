...
exports.test = bddWorkerFixtures_1.test.extend({
    ...
    $beforeEach: [
        async ({ $bddContext, $world, $beforeEachFixtures }, use) => {
            ...
            await (0, scenario_1.runScenarioHooks)(hooksToRun, $world, { $bddContext, ...$beforeEachFixtures });
            await use();
        },
        fixtureOptions,
    ],
    ...
    $afterEach: [
        async ({ $bddContext, $world, $afterEachFixtures }, use) => {
            ...
            hooksToRun.reverse();
            await (0, scenario_1.runScenarioHooks)(hooksToRun, $world, { $bddContext, ...$afterEachFixtures });
        },
        fixtureOptions,
    ],
    $prompt: [
